...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    type: 'multi',
    options: ['Software Engineer', 'Data Scientist', 'Product Manager', 'UX Designer', 'DevOps Engineer', 'ML Engineer', 'Engineering Manager', 'Research Scientist'],
    icon: <BriefcaseIcon />,
  },
  {
    id: 3,
    ...
    type: 'multi',
    options: ['Python', 'JavaScript/TypeScript', 'React/Vue/Angular', 'Machine Learning', 'SQL & Databases', 'Cloud (AWS/GCP/Azure)', 'Data Engineering', 'System Design', 'Leadership', 'Communication'],
    icon: <Zap size={18} />,
  },
  {
    id: 4,
    ...
    type: 'multi',
    options: ['Technology / SaaS', 'Healthcare / Biotech', 'Finance / Fintech', 'E-commerce / Retail', 'Energy / Climate', 'Education / EdTech', 'Government / Defense', 'Media / Entertainment'],
...
export default function InterviewPage() {
  ...
  const handleLocationSubmit = () => {
    ...
    const newAnswers = { ...answers, [currentQuestion.id]: locationInput.trim() };
    setAnswers(newAnswers);
    triggerFlash(currentQuestion.category);
  };
  ...
  return (
    ...
    >
      ...
      <section className="mx-auto max-w-[960px] px-4 pt-16 pb-8 sm:pt-20">
        ...
        >
          Our AI will ask you a few targeted questions to understand exactly what
          you&apos;re looking for. The more detail you provide, the better our matches.
        </motion.p>
        ...
        >
          <div className="flex items-center justify-between gap-2">
            {['Upload', 'Interview', 'Research', 'Results', 'Resumes'].map((label, i) => (
          ...
          >
            <motion.div
              ...
              initial={{ width: '20%' }}
              animate={{ width: isComplete ? '40%' : `${20 + (progress * 0.2)}%` }}
              transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] as [number, number, number, number] }}
            />
          </div>
        </motion.div>
      ...
      {!isComplete ? (
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
                    ...
                    >
                      ...
                      <div className="mt-8">
                        ...
                        {currentQuestion.type === 'text' && (
                          <textarea
                            ...
                            onFocus={(e) => {
                              ...
                              e.currentTarget.style.boxShadow = '0 0 0 3px rgba(0, 201, 255, 0.12)';
                            }}
                            onBlur={(e) => {
                            ...
                            {currentQuestion.options.map((option) => {
                              ...
                              return (
                                <button
                                  ...
                                  style={{
                                    borderColor: selected ? 'var(--electric-blue)' : 'var(--slate-700)',
                                    backgroundColor: selected
                                      ? 'rgba(0, 201, 255, 0.08)'
                                      : 'var(--midnight)',
                                    color: selected ? 'var(--electric-blue)' : 'var(--ice-white)',
                                  }}
                                  onMouseEnter={(e) => {
                                    if (!selected) {
                                ...
                                >
                                  <div
                                    ...
                                    style={{
                                      borderColor: selected ? 'var(--electric-blue)' : 'var(--slate-600)',
                                    }}
                                  >
                                    {selected && (
                                      <div
                                ...
                                <button
                                  ...
                                  style={{
                                    backgroundColor: selected
                                      ? 'rgba(0, 201, 255, 0.15)'
                                      : 'var(--midnight)',
                                    color: selected ? 'var(--electric-blue)' : 'var(--slate-400)',
                                    border: selected
                        ...
                        {currentQuestion.type === 'scale' && currentQuestion.scaleLabels && (
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-between text-xs" style={{ color: 'var(--slate-500)' }}>
                        ...
                        {currentQuestion.type === 'location' && (
                          <div className="space-y-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {['Remote', 'San Francisco', 'New York', 'Austin', 'Seattle', 'Los Angeles'].map(
                                (city) => (
                                  <button
                                    key={city}
                                    onClick={() => {
                                      setLocationInput(city);
                                      const newAnswers = { ...answers, [currentQuestion.id]: city };
                                      setAnswers(newAnswers);
                      ...
                      <div className="mt-8 flex items-center justify-between">
                        <button
                          ...
                          style={{ color: 'var(--slate-400)' }}
                          onMouseEnter={(e) => {
                            if (currentIndex > 0) e.currentTarget.style.color = 'var(--ice-white)';
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.color = 'var(--slate-400)';
                          }}
            ...
            <div className="lg:w-[40%]">
              ...
              >
                ...
                {/* Question Progress */}
                <div className="mt-6 border-t pt-4" style={{ borderColor: 'var(--slate-700)' }}>
        ...
        <section className="mx-auto flex max-w-[560px] flex-col items-center px-4 pt-8 pb-20 text-center">
          ...
          <motion.p
            ...
            style={{ color: 'var(--slate-400)' }}
          >
            We&apos;ve built a detailed profile of your skills, preferences, and goals.
            Our agents are ready to find your perfect matches.
          </motion.p>
          ...
          >
            <h4 className="mb-4 text-sm font-semibold" style={{ color: 'var(--ice-white)' }}>
              Profile Summary
            </h4>
