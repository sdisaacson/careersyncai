...
function extractProfileFromText(text: string): ExtractedProfile {
  ...
  const nameCandidate =
    nameLine.length < 50 && !nameLine.toLowerCase().includes("resume")
      ? nameLine
      : "Candidate";
  ...
  return {
    ...
    education:
      eduLines.slice(0, 2).join("; ") || "Education data extracted from resume",
    skills:
...
export default function UploadPage() {
  ...
  const processFile = async (file: File) => {
    ...
    try {
      ...
      setUploadState("error");
      setErrorMsg(
        "Failed to parse the file. Please try again with a different file."
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      <section className="mx-auto max-w-[800px] px-4 pt-16 pb-12 sm:pt-20 sm:pb-12">
        ...
        >
          We&apos;ll scan your resume to understand your skills, experience, and
          education. Then our AI will ask a few clarifying questions.
        </motion.p>
                ...
                style={{
                  ...
                  backgroundColor:
                    uploadState === "dragover"
                      ...
                      : "rgba(30, 58, 138, 0.05)",
                  transform:
                    uploadState === "dragover" ? "scale(1.01)" : "scale(1)",
                  boxShadow:
                    uploadState === "dragover"
            ...
            >
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "var(--slate-400)" }}
                >
                  Review your extracted information above. You can edit details
                  in the next step.
                </p>
