    ...
    >
      <section className="mx-auto flex min-h-[100dvh] max-w-[1000px] flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <motion.h1
          ...
          style={{ color: 'var(--ice-white)', lineHeight: 1.1, letterSpacing: '-0.02em' }}
        >
        ...
        >
          Follow Barbara, a recent Art History graduate, as CareerSync parses her
          resume, interviews her, finds matching roles, and generates tailored
          resumes — all in one seamless flow.
        </motion.p>
