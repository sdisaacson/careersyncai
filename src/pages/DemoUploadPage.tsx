    ...
    >
      ...
      <section className="mx-auto max-w-[800px] px-4 pt-16 pb-12 sm:pt-20 sm:pb-12">
        ...
        >
          ...
          or DOCX are accepted. Once the resume is uploaded, CareerSyncAI extracts
          and saves her information for later.
        </motion.p>
      ...
      <section className="mx-auto max-w-[720px] px-4 pb-20">
        ...
        >
          <div className="mb-6 flex items-center gap-2">
            ...
            <h3 className="text-xl font-semibold" style={{ color: 'var(--ice-white)' }}>
              Extracted Profile
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                {profile.skills.split(',').slice(0, 8).map((skill) => (
                  <span
                    key={skill.trim()}
