...
import { InsightsPanel } from "@/components/datasheet/InsightsPanel";
...
export default function DatasheetPage() {
  ...
  const isRealData = !!(jobsQuery.data && jobsQuery.data.length > 0);
