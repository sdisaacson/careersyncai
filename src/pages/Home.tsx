  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #0B0E14 0%, #111827 40%, #1E3A8A 100%)",
        }}
      />
      ...
      >
        ...
        >
          Upload your resume. Answer a few questions. Our AI interviews you,
          researches 100+ opportunities across every sector, and generates
          tailored applications — all in minutes.
        </motion.p>
        ...
        >
          {["100+ Jobs", "8 Sectors", "Tailored Resumes", "2 Min Setup"].map(
            (item, i) => (
        ...
        <div className="mb-16 text-center">
          ...
          <SectionReveal delay={0.2}>
            <p
              ...
              style={{ color: "#94A3B8", lineHeight: 1.6 }}
            >
              From resume upload to tailored applications — CareerSync handles
              the entire job search pipeline with AI precision.
            </p>
          </SectionReveal>
        </div>
        ...
        >
          ...
          <div className="p-8 sm:w-1/2 sm:p-12">
            ...
            <p className="mt-4" style={{ color: "#94A3B8", lineHeight: 1.6 }}>
              See all 100+ opportunities organized by sector, priority, and fit
              score. Filter, sort, and compare side by side.
            </p>
            <ul className="mt-6 flex flex-col gap-3">
              {[
                ...
                >
                  <CheckCircle
                    size={16}
                    style={{ color: "#00C9FF", flexShrink: 0 }}
                  />
                  {item}
                </li>
              ))}
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[700px] px-4 text-center sm:px-6 lg:px-8">
        ...
        <motion.p
          ...
          style={{ color: "#94A3B8", lineHeight: 1.6 }}
        >
          Upload your resume and let our AI do the rest. Plans start at $9/mo
