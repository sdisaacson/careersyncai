...
function FitScorePill({
  ...
  const padding =
    size === "lg" ? "8px 18px" : size === "md" ? "6px 14px" : "4px 10px";
        ...
        <>
          ...
          >
              ...
              <div className="mb-6 flex items-center gap-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    {
                      label: "Skills",
                      value: Math.min(100, (job.fitScore ?? 0) + 2),
                    },
                    {
                      label: "Experience",
                      value: Math.min(100, (job.fitScore ?? 0) + 1),
                    },
                    {
                      label: "Location",
                      value: Math.min(100, (job.fitScore ?? 0) - 1),
            ...
            <div
              ...
              style={{ borderColor: "#334155", backgroundColor: "#111827" }}
            >
...
export default function DashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    const avgFitScore =
      total > 0
        ? Math.round(jobs.reduce((s, j) => s + (j.fitScore ?? 0), 0) / total)
        : 0;
  ...
  const filteredJobs = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      if (sortField === "deadline")
        return dir * ((a.deadline || "") > (b.deadline || "") ? 1 : -1);
      return (
        dir *
        ...
        >
          ...
          >
            ...
            <p className="mt-3 max-w-2xl text-lg" style={{ color: "#94A3B8" }}>
              We&apos;ve found{" "}
              <span className="font-semibold" style={{ color: "#00C9FF" }}>
                {stats.total}
              </span>{" "}
              roles across{" "}
              <span className="font-semibold" style={{ color: "#00C9FF" }}>
              ...
              sectors. Each has been analyzed against your profile and scored
              for fit.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              },
              {
                ...
                icon: BarChart3,
                color:
                  stats.avgFitScore >= 80
                    ? "#22C55E"
                    : stats.avgFitScore >= 60
                      ? "#3B82F6"
                      : "#94A3B8",
              },
              {
              ...
              {
                label: "High Priority",
                value: jobs.filter(j => (j.fitScore ?? 0) >= 80).length,
                icon: Star,
                color: "#22C55E",
              },
            ].map(stat => (
        ...
        <div className="mx-auto flex max-w-[1400px] flex-wrap items-center gap-3 px-4 py-4 sm:px-6 lg:px-8">
          ...
          >
            <button
              ...
              style={{
                backgroundColor:
                  viewMode === "grid" ? "rgba(0, 201, 255, 0.12)" : "#1E293B",
                color: viewMode === "grid" ? "#00C9FF" : "#94A3B8",
              }}
            >
              <LayoutGrid size={16} />
            </button>
            <button
              ...
              style={{
                backgroundColor:
                  viewMode === "list" ? "rgba(0, 201, 255, 0.12)" : "#1E293B",
                color: viewMode === "list" ? "#00C9FF" : "#94A3B8",
              }}
            >
              <List size={16} />
            </button>
        ...
        {filteredJobs.length === 0 ? (
          ...
          >
            ...
            <p
              ...
              style={{ color: "#94A3B8" }}
            >
              Try adjusting your search criteria, lowering the minimum fit
              score, or selecting a different sector.
            </p>
            <button
              onClick={() => {
                setSearchQuery("");
