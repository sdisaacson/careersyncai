...
export default function Footer() {
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8" style={{ paddingTop: '80px', paddingBottom: '40px' }}>
        {/* 4-column grid */}
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed" style={{ color: '#94A3B8' }}>
              AI-powered job matching and application generation. Upload your resume, get interviewed by AI, and receive 100 tailored job applications.
            </p>
        ...
        <div
          ...
          style={{ borderTop: '1px solid rgba(148, 163, 184, 0.08)', paddingTop: '24px' }}
        >
