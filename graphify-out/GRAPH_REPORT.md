# Graph Report - app (2026-06-28)

## Corpus Check

- 209 files · ~159,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1744 nodes · 2681 edges · 118 communities (103 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `871fd039`
...
- `React` --conceptually_related_to--> `CareerSyncAI` [INFERRED]
  README.md → info.md
- `Vite` --semantically_similar_to--> `Vite` [INFERRED] [semantically similar]
  info.md → README.md
- `seed()` --calls--> `getDb()` [INFERRED]
  db/seed.ts → server/queries/api/connection.ts
...
Cohesion: 0.05
Nodes (38): `AdminLayout.tsx` (`src/components/AdminLayout.tsx`), Animated Section Reveal, `AnimatedCounter.tsx` (`src/components/AnimatedCounter.tsx`), Animation Components, Animation Patterns, `AuthLayout.tsx` (`src/components/AuthLayout.tsx`), `AuthLayoutSkeleton.tsx` (`src/components/AuthLayoutSkeleton.tsx`), Button with Glow (+30 more)

### Community 2 - "Core App & Pages"

Cohesion: 0.05
Nodes (62): easeOutExpo, easeOutExpo, PLAN_OPTIONS, SETTING_KEYS, AdminLayout(), AuthLayout(), footerColumns, Layout() (+54 more)
...
Cohesion: 0.04
Nodes (48): allowScripts, core-js@3.49.0, esbuild@0.27.7, sharp@0.34.5, workerd@1.20260625.1, devDependencies, autoprefixer, babel-plugin-react-compiler (+40 more)
...
Cohesion: 0.13
Nodes (16): adminQuery, authedQuery, requireAuth, t, appSettings, researchSessions, sectors, subscriptions (+8 more)
...
Cohesion: 0.11
Nodes (17): app, app, createContext(), TrpcContext, AppRouter, authenticateRequest(), getAppSecret(), SessionPayload (+9 more)
...
Cohesion: 0.05
Nodes (37): AI Models & APIs Used, Complete Data Flow Architecture, Configuration, Current Implementation Status, Data Flow, Data Usage, Database Storage, Database Storage (+29 more)

### Community 14 - "Auth Layout & Sidebar"

Cohesion: 0.06
Nodes (34): Admin Assignment, Authentication, Before Production, Best Practices, Connection Security, Cookie Security, CORS & CSRF, CORS Policy (+26 more)
...
Cohesion: 0.06
Nodes (42): cn(), AccordionContent(), AccordionItem(), AccordionTrigger(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList() (+34 more)

### Community 21 - "Interview API & Schema"

Cohesion: 0.08
Nodes (25): AppSetting, InsertAppSetting, InsertInterview, InsertInterviewQuestion, InsertJob, InsertProfile, InsertSector, InsertSubscription (+17 more)
...
Cohesion: 0.29
Nodes (8): CareerSyncAI, CareerSyncAI, Node.js 20, shadcn/ui, Tailwind CSS, Vite, TypeScript, Vite

### Community 31 - "Community 31"

Cohesion: 0.24
Nodes (10): FormControl(), FormDescription(), FormItem(), FormLabel(), FormMessage(), FormFieldContext, FormFieldContextValue, FormItemContext (+2 more)
...
Cohesion: 0.07
Nodes (27): Architecture, Auth System Design, Backend Architecture, Build System, Component Hierarchy, Context (`api/context.ts`), Data Flow: The 5-Step Journey, Database Architecture (+19 more)

### Community 35 - "Navigation Menu UI"

Cohesion: 0.22
Nodes (9): NavigationMenu(), NavigationMenuContent(), NavigationMenuIndicator(), NavigationMenuItem(), NavigationMenuLink(), NavigationMenuList(), NavigationMenuTrigger(), NavigationMenuViewport() (+1 more)
...
Cohesion: 0.11
Nodes (22): easeOutExpo, easeOutExpo, AuthLayoutSkeleton(), Badge(), BadgeProps, badgeVariants, Empty(), EmptyContent() (+14 more)
...
Cohesion: 0.08
Nodes (24): 1. Clone & Install, 2. Configure Environment Variables, 3. Database Setup, 4. Seed Data (Optional), Add a New Page, Add a New tRPC Router, Add a shadcn/ui Component, Adding a New Table (+16 more)

### Community 53 - "Community 53"

Cohesion: 0.08
Nodes (23): Admin Features, Admin Setup, Build Process, Database Deployment, Deployment Guide, Docker (Optional), Environment Variables, Error Tracking (+15 more)
...
Cohesion: 0.13
Nodes (13): fullSchema, getDatabaseUrl(), jobsRelations, profilesRelations, subscriptionsRelations, tailoredResumesRelations, usersRelations, jobs (+5 more)
...
Cohesion: 0.09
Nodes (23): Aggregation, Apply Migrations, `appSettings`, Basic CRUD with Drizzle, Configuration, Database Reference, Entity Relationship Diagram, Enums (+15 more)
...
Cohesion: 0.80
Nodes (4): buildUrl(), sendEmail(), sendPasswordResetEmail(), sendVerificationEmail()

### Community 76 - "Community 76"

Cohesion: 0.24
Nodes (14): getDb(), createUser(), findUserByEmail(), findUserById(), findUserByResetToken(), findUserByVerificationToken(), getAdminEmails(), incrementSessionVersion() (+6 more)
...
Cohesion: 0.14
Nodes (13): 5-Step Pipeline Flow, Admin Guard Pattern, Admin Routes, Auth Guard Pattern, Authenticated Routes, Not Found, Public Routes, Query Parameters (+5 more)

### Community 100 - "Community 100"

Cohesion: 0.22
Nodes (9): `auth.forgotPassword`, `auth.login`, `auth.logout`, `auth.me`, `auth.resendVerification`, `auth.resetPassword`, Auth Router (`auth`), `auth.signup` (+1 more)

### Community 101 - "Community 101"

Cohesion: 0.22
Nodes (9): `job.create`, `job.createMany`, `job.deleteByProfile`, `job.filter`, `job.getById`, `job.getByProfile`, Job Router (`job`), `job.stats` (+1 more)

### Community 102 - "Community 102"

Cohesion: 0.22
Nodes (8): [0.1.0] — 2025-06-27, Changelog, Database, Future Roadmap, Initial Release, Known Issues, Planned, Under Consideration

### Community 103 - "Community 103"

Cohesion: 0.22
Nodes (9): Admin Portal, Authentication & User Management, Data Sheet, Features, Job Discovery, Resume Pipeline (5-Step Journey), Resume Tailoring, Tech Stack (+1 more)

### Community 104 - "Community 104"

Cohesion: 0.36
Nodes (6): ToggleGroup(), ToggleGroupContext, ToggleGroupItem(), Toggle(), ToggleProps, toggleVariants

### Community 105 - "Community 105"

Cohesion: 0.25
Nodes (8): API Reference, Auth & Middleware, Client Usage, Error Codes, Health Check, Middleware Levels, Router Overview, Session Authentication

### Community 106 - "Community 106"

Cohesion: 0.25
Nodes (8): `interview.addQuestion`, `interview.answerQuestion`, `interview.complete`, `interview.create`, `interview.get`, `interview.getQuestions`, `interview.nextQuestion`, Interview Router (`interview`)

### Community 107 - "Community 107"

Cohesion: 0.29
Nodes (7): `research.appendLog`, `research.complete`, `research.create`, `research.fail`, `research.get`, Research Router (`research`), `research.updateProgress`

### Community 108 - "Community 108"

Cohesion: 0.29
Nodes (7): Available Scripts, CareerSync AI, Documentation, License, Project Structure, Quick Start, Tech Stack

### Community 110 - "Community 110"

Cohesion: 0.33
Nodes (6): `profile.create`, `profile.getById`, `profile.getByUser`, `profile.list`, Profile Router (`profile`), `profile.update`

### Community 111 - "Community 111"

Cohesion: 0.33
Nodes (6): `resume.create`, `resume.createMany`, `resume.getByJob`, `resume.getByProfile`, Resume Router (`resume`), `resume.updatePdfUrl`

### Community 112 - "Community 112"

Cohesion: 0.40
Nodes (5): `admin.dashboard`, Admin Router (`admin`), `admin.subscriptions.list`, `admin.users.list`, `admin.users.updateRole`

### Community 113 - "Community 113"

Cohesion: 0.40
Nodes (5): `settings.get`, `settings.getAll`, Settings Router (`settings`), `settings.update`, `settings.updateMany`

### Community 114 - "Community 114"

Cohesion: 0.40
Nodes (5): `subscription.cancelSubscription`, `subscription.createCheckoutSession`, `subscription.getCurrentSubscription`, `subscription.resumeSubscription`, Subscription Router (`subscription`)

### Community 115 - "Community 115"

Cohesion: 0.50
Nodes (4): `sector.getById`, `sector.list`, Sector Router (`sector`), `sector.seed`

### Community 116 - "Community 116"

Cohesion: 0.50
Nodes (4): Auth Links, Footer Links, Navbar Links (Desktop), Navigation Structure

## Knowledge Gaps

- **819 isolated node(s):** `RequestConfig`, `App`, `$schema`, `style`, `rsc` (+814 more)
...
- **Why does `cn()` connect `Menubar UI` to `Chart UI`, `Core App & Pages`, `Navigation Menu UI`, `UI Primitives`, `Community 104`, `Community 59`, `Empty State UI`, `Toggle UI`, `Button Group & Item UI`, `Sidebar & Tooltip UI`, `Community 50`, `Dropdown Menu UI`, `Hover Card UI`, `Carousel UI`, `Input & Textarea UI`, `Community 62`, `Community 31`?**
...
- **Why does `AppRouter` connect `Kimi Auth & Session` to `API & Database Core`, `Core App & Pages`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `RequestConfig`, `App`, `$schema` to the rest of the system?**
